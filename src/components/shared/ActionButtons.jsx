...
export default function ActionButtons({ onEdit, onDelete }) {
  return (
    <div className="flex justify-end gap-1.5">
      <button 
         onClick={onEdit} 
         className="h-8.5 w-8.5 inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-400 hover:text-zinc-950 hover:border-zinc-300 transition-all shadow-sm"
      >
      ...
      <button 
         onClick={onDelete} 
         className="h-8.5 w-8.5 inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-400 hover:text-red-600 hover:border-red-200 transition-all shadow-sm"
      >
