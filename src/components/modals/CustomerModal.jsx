            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
               ...
               <div className="flex gap-3 pt-4 border-t border-zinc-100">
                  <button 
                     ...
                     className="flex-1 h-11 rounded-xl text-[11px] font-black uppercase tracking-tight text-zinc-500 hover:text-zinc-950 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                     Cancel
                  </button>
                   <button 
                      type="submit"
                      disabled={isSubmitting}
                      className="flex-[2] h-11 flex items-center justify-center gap-2 rounded-xl bg-zinc-950 text-white text-[11px] font-black uppercase tracking-tight shadow-xl shadow-zinc-950/20 hover:bg-zinc-900 disabled:opacity-50 transition-all active:scale-[0.98] border border-zinc-800 disabled:cursor-wait"
                   >
                      {isSubmitting ? (
                        <>
