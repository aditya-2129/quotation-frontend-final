...
const ValuationLedger = ({
  ...
  const LineItem = ({
    ...
    return (
      <div
        className={`flex justify-between items-center text-[13px] transition-all duration-300 ${active ? `${highlightColor} scale-[1.02] translate-x-1` : colorClass}`}
      >
        <span
        ...
        <div className="space-y-2.5 relative z-10">
          ...
          <div className="flex justify-between items-center group/subtotal">
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest group-hover/subtotal:text-zinc-300 transition-colors block mb-0.5">
                Unit Manufacturing Cost
              </span>
              <span className="text-[8px] text-zinc-600 font-bold uppercase italic">
                Direct Factory Cost / Unit
              </span>
            </div>
            <span className="text-lg font-mono font-black tracking-tighter italic">
              ₹
        ...
        <div className="mt-6 pt-4 border-t border-zinc-900 relative z-10">
          <div className="flex justify-between items-center mb-4">
            <div className="flex flex-col">
              ...
              <span className="text-[8px] text-zinc-600 font-bold uppercase mt-1 italic">
                Industrial Markup
              </span>
            </div>
            <input
          ...
          <div className="flex flex-col mb-6 p-3 bg-zinc-900/50 rounded-xl border border-zinc-900 shadow-inner">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[8px] font-bold text-zinc-700 uppercase tracking-widest italic">
                Per Item
              </span>
            </div>
            ...
            <div className="relative flex items-center gap-2 px-4 bg-zinc-950">
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-900 border border-zinc-800 rounded-full shadow-2xl ring-1 ring-zinc-800/50 group/qty">
                ...
                <div className="h-4 w-4 rounded-md bg-zinc-950 flex items-center justify-center">
                  <svg
                    className="h-2.5 w-2.5 text-brand-primary"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span className="text-[13px] font-mono font-black text-white px-2 leading-none">
                  {formData.quantity || 1}
                </span>
          ...
          <div className="flex flex-col relative group/total pb-2">
            ...
            <div className="flex items-center justify-between mb-2 relative z-10">
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest mt-1.5 italic">
                  Consolidated Order Value
                </span>
              </div>
            </div>
            <div className="flex items-baseline gap-2 relative z-10">
              <span className="text-4xl font-mono font-black tracking-tighter text-white leading-none drop-shadow-2xl">
                ₹
