...
const ValuationLedger = ({ totals, activeQuote, setActiveQuote, formData, setFormData, activePhase }) => {
  ...
  return (
    <div className="sticky top-24 space-y-4">
       <section className="bg-zinc-950 rounded-2xl p-4 text-white shadow-2xl shadow-zinc-200 relative overflow-hidden border border-zinc-900">
          ...
          <div className="mt-8 pt-5 border-t border-zinc-900 relative z-10">
             <div className="flex justify-between items-center mb-6">
                ...
                <input 
                  type="number" 
                  className="w-16 h-10 bg-zinc-900 border border-zinc-800 rounded-xl text-center text-[13px] font-black focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-all outline-none text-white shadow-inner"
             ...
             <div className="flex flex-col">
                <div className="flex items-center justify-between mb-2">
                   <span className="text-[11px] font-black text-brand-primary uppercase tracking-[0.2em] leading-none">Final Total Price</span>
