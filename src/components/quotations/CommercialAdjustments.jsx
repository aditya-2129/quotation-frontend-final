    ...
    <section className={`bg-white rounded-2xl border transition-all duration-300 overflow-hidden ${isExpanded ? 'border-zinc-300 shadow-xl ring-1 ring-zinc-200/50' : 'border-zinc-200 shadow-sm'}`}>
       ...
       >
          <div className="flex items-center gap-3">
             ...
             <h3 className={`text-[13px] font-black uppercase tracking-[0.2em] transition-colors ${isExpanded ? 'text-zinc-950' : 'text-zinc-500 group-hover:text-zinc-700'}`}>Commercial Adjustments & Logistics</h3>
          </div>
             ...
             <div className="mb-10 border border-zinc-200 rounded-2xl bg-white shadow-sm overflow-hidden animate-in fade-in duration-700">
                <div className="px-6 py-4 bg-zinc-50 border-b border-zinc-100 flex justify-between items-center">
                   <div className="flex items-center gap-4">
                      <div className="h-8 w-8 rounded-lg bg-emerald-600 text-white flex items-center justify-center shadow-lg shadow-emerald-600/20">
                      ...
                      <div>
                         <h4 className="text-[13px] font-black text-zinc-950 uppercase tracking-tight">Project Logistics & Fulfillment</h4>
                         <span className="text-[9px] text-zinc-400 font-bold uppercase tracking-[0.15em] italic font-mono leading-none">Global Commercial Adjustments</span>
                      </div>
                   </div>
                   <div className="flex gap-2">
                      <span className="text-[9px] font-black text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded border border-emerald-100 uppercase tracking-tighter">Fulfillment Phase</span>
                   </div>
                </div>
                ...
                <div className="p-8 grid grid-cols-2 gap-12 bg-white">
                   <div className="relative">
                      <div className="flex flex-col mb-4">
                         <span className="text-[9px] font-black text-emerald-500 uppercase tracking-[0.2em] mb-1.5 leading-none italic">Logistics Phase</span>
                         <h4 className="text-[14px] font-black text-zinc-950 uppercase tracking-tight">Packaging & Forwarding</h4>
                      </div>
                      ...
                      <p className="mt-3 text-[8px] text-zinc-400 font-bold uppercase tracking-tight italic leading-relaxed">Industrial standard sea-worthy or domestic packing charges for the entire batch.</p>
                   </div>

                   <div className="relative">
                      <div className="flex flex-col mb-4">
                         <span className="text-[9px] font-black text-blue-500 uppercase tracking-[0.2em] mb-1.5 leading-none italic">Distribution Phase</span>
                         <h4 className="text-[14px] font-black text-zinc-950 uppercase tracking-tight">Inland Transportation</h4>
                      </div>
                      <div className="relative group">
                         <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[11px] text-zinc-400 font-black">₹</span>
                         <input 
                      ...
                      <p className="mt-3 text-[8px] text-zinc-400 font-bold uppercase tracking-tight italic leading-relaxed">Ex-Works or Door Delivery logistic charges for final batch delivery.</p>
                   </div>
                </div>
             </div>
             ...
             <div className="mb-8 border border-zinc-200 rounded-2xl bg-white shadow-sm overflow-hidden animate-in fade-in duration-500">
                <div className="px-6 py-4 bg-zinc-50 border-b border-zinc-100 flex justify-between items-center">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         <h4 className="text-[13px] font-black text-zinc-950 uppercase tracking-tight">Project Engineering & Design Services</h4>
                         <span className="text-[9px] text-zinc-400 font-bold uppercase tracking-[0.15em] italic font-mono leading-none">Fixed One-Time Fees</span>
                      </div>
                   </div>
                   <div className="flex gap-2">
                ...
                <div className="p-8 grid grid-cols-2 gap-10 bg-white">
                   <div className="relative">
                      <label className="block text-[9px] font-black text-zinc-400 uppercase tracking-[0.18em] leading-none mb-3 italic">One-Time Project Design Fee (₹)</label>
                      <div className="relative group">
                      ...
                      <p className="mt-3 text-[8px] text-zinc-400 font-bold uppercase tracking-tight italic leading-relaxed">CAD/CAM Programming, JIG/Fixture Design, and specialized technical overhead.</p>
                   </div>
                   <div className="relative">
                      <label className="block text-[9px] font-black text-zinc-400 uppercase tracking-[0.18em] leading-none mb-3 italic">Batch Assembly & Integration Fee (₹)</label>
                      <div className="relative group">
                         <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[11px] text-zinc-400 font-bold">₹</span>
                         <input 
                           type="number" 
                      ...
                      <p className="mt-3 text-[8px] text-zinc-400 font-bold uppercase tracking-tight italic leading-relaxed">Covers final component integration, manual fitting, and project-wide assembly labor.</p>
                   </div>
                </div>
             </div>
