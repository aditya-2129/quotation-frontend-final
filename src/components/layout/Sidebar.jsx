...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    { name: 'Materials Master', href: '/materials', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
    { name: 'Labor & Processes', href: '/labor-rates', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Tooling Masters', href: '/tooling-rates', icon: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z' },
    { name: 'BOP Registry', href: '/bop-library', icon: 'M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4z' },
  ];
      ...
      <div className="flex h-16 items-center justify-between border-b border-zinc-100 px-4">
        {!isCollapsed && (
          <div className="flex items-center gap-2 overflow-hidden whitespace-nowrap">
            <div className="h-8 w-8 min-w-[32px] rounded bg-zinc-950 flex items-center justify-center">
              <span className="text-white font-bold">Q</span>
            </div>
            <span className="text-xl font-bold tracking-tight text-zinc-950">QUOTEMAKE</span>
          </div>
        )}
        {isCollapsed && (
          <div className="mx-auto h-8 w-8 rounded bg-zinc-950 flex items-center justify-center">
            <span className="text-white font-bold">Q</span>
          </div>
        )}
        <button 
