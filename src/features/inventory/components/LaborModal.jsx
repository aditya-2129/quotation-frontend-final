    ...
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-zinc-950/20 backdrop-blur-sm" style={{ zIndex: THEME.Z_INDEX.MODAL }}>
      <div className="w-full max-w-md bg-white rounded-xl border border-zinc-200 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
           <div>
              <label className="block font-bold text-zinc-400 uppercase tracking-widest mb-1.5" style={{ fontSize: THEME.FONT_SIZE.TINY }}>Process Descriptor *</label>
              <input 
                required 
           ...
           <div>
              <label className="block font-bold text-zinc-400 uppercase tracking-widest mb-1.5" style={{ fontSize: THEME.FONT_SIZE.TINY }}>Rate Calculation Unit *</label>
              <select 
                required 
                className="w-full h-10 px-4 rounded-lg bg-zinc-50 border border-zinc-200 font-bold outline-none focus:ring-2 focus:ring-zinc-950 focus:bg-white"
                style={{ fontSize: THEME.FONT_SIZE.BASE }}
           ...
           <div>
              <label className="block font-bold text-zinc-400 uppercase tracking-widest mb-1.5" style={{ fontSize: THEME.FONT_SIZE.TINY }}>Unit Rate (₹) *</label>
              <input 
                required 
                type="number" 
                step="0.01" 
